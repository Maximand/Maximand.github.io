...
These observations do not prove intent or direct involvement in abuse operations. They do, however, establish operational proximity between the provider’s administrative layer and accounts independently linked to abuse infrastructure.
...
This does not establish intent or direct operation. However, it does show that administrator-linked access material is present on multiple systems that are also used in abuse-related infrastructure.
